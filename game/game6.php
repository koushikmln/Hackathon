		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 6</span>
					</h1>
					<p>
						Cyberoam admins being pro students wanted to protect the students from all sorts of mishaps that happen online.Thay wanted to make a software to block all the ports open on  system and return the sum of the open ports as a result. See if you could also make something similar and check the open ports on 172.16.32.222 and 172.16.32.254. The sum of this is the key to your next level.
					</p>
					<br>
					<p>
						<center>
