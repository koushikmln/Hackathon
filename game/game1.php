<?php
include '../config.php';
setcookie("Hint", "Et tu, illuminati");
...
<body>
		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 1</span>
					</h1>
					<p>
						"Fxg tm lhfx mbfx tkx ftlmxkl hy maxbk ytmxl: Max ytnem, wxtk Uknmnl, bl ghm bg hnk lmtkl, unm bg hnklxeoxl, matm px tkx ngwxkebgzl.Max dxr mh max gxqm exoxe bl max dxr hy max vbiaxk."		
					</p>
					<br>
					<p>
						<center>
	...
	<script type="text/javascript" src="<?php echo JS_URL; ?>scaler.js"></script>
