		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 3</span>
					</h1>
					<p>
					In Ancient Egypt, Cats were worshipped as gods. This cat is getting frustrated that you cannot understand his divine judgement. Figure out what he is trying to say before he curses you.
					...
					<img src="../uploads/cat.png"/>
							<form method="POST" action="../answer.php">
								<input name="answer" type="text" placeholder="What does the cat say?" class="form-control input-md" required>
								<br>
