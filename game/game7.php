		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 7</span>
					</h1>
					<p>
						Sylar needs his phone to get a 4 digit Number Key from his phone. Being the king of lazy people, he does not want to get up from his seat. Luckily he has you and the page which does the authentication is not exactly Alcatraz. <a href="../level/level7.php"> (4D secure auth ) </a>
					</p>
					<br>
					<p>
						<center>
