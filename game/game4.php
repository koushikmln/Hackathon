		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 4</span>
					</h1>
					<p>
						One of the admins has built a an extremely narcissistic code and named it BIT-Bot. The probability of getting the key for the next level is 1/10000 . Try and try until you succeed.<br>
						<a href="../downloads/bitbot.exe">Windows BOT</a>
					...
					<p>
						<center>
							<form method="POST" action="../answer.php">
								<input name="answer" type="text" placeholder="Enter Answer" class="form-control input-md" required>
								<br>
