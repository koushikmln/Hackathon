		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					...
					<p>
					If you've reached this far, you must be smart enough to realize we don't build secure sites. Still, you've made it this far, so congratulations are in order. Read the final instructions  <a href="../uploads/password.txt">here. </a> Also we need your photos, so upload them <a href="../level/level10.php">here</a>
					</p>
					<br>
					<p>
						<center>
