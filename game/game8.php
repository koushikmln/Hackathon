		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				...
				<div class="jumbotron" id = "main-box">
					<h1>
						<span id="qtitle">Level 8</span>
					</h1>
					<p>
						After getting placed in microsoft sylar wanted to make fun of all those who were preparing for google. He started posting bing.com on random peoples walls. He is giving the key of this level also to people who access <a href="../level/level8.php">this</a> site through bing.com . Enter the key to complete this level.
					</p>
					<br>
					<p>
						<center>
